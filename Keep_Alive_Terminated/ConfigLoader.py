...
class ConfigLoader:
    ...
    @staticmethod
    def load_config(filename='Keep_Alive_Terminated/config.yaml'):
        ...
        # Read 'keep-alive-ms' from docker_config
        keep_alive_ms = config['outputs'][0].get('keep-alive-ms', 10000) / 1000  # in seconds
