...
#CODICE CHE PRENDE DA KAFKA E STAMPA SU KAFKA SU TOPIC SPECIFICI.
...
if __name__ == "__main__":
    ...
    input_topic = os.environ.get('INPUT_TOPIC', 'temperature_input')
    output_topic = os.environ.get('OUTPUT_TOPIC', 'temperature_output')
