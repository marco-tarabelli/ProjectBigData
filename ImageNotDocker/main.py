...
class TemperatureGenerator:
    def __init__(self, kafka_broker):
        ...
        self.input_topic = "input_topic"  # Modifica qui per il topic di input predefinito
        self.output_topic = "output_topic"  # Modifica qui per il topic di output predefinito
        self.consumer = KafkaConsumer(bootstrap_servers=kafka_broker, auto_offset_reset='earliest')
        self.consumer.subscribe(topics=[self.input_topic])
...
if __name__ == "__main__":
    ...
    temperature_generator = TemperatureGenerator(kafka_broker)
    input_topic = temperature_generator.input_topic
    output_topic = temperature_generator.output_topic
